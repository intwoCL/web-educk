      ...
      <div class="row">
        <div class="col-lg-6 col-xl-6">
          <div class="text-container">
            <img src="{{ asset('me/logoeduck.svg') }}" width="150px" alt="logo educk">
            <h1 style="text-shadow: 1px 1px 2px rgba(0, 0, 0, 0.6);">
              ¡Garantizamos el éxito de tus futuras <span class="edu-text-black3">decisiones <span id="typed-element"></span>
            </span>!
            </h1>
        ...
        <div class="col-lg-6 col-xl-6">
          <div class="image-container">
            <div class="img-wrapper">
              <img class="img-fluid" src="{{ $context['banner'] }}" alt="alternative">
            </div>
          </div>
        </div>
      </div>
