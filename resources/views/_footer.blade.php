...
<div class="footer" style="background:#080808;">
  <div class="container">
    <div class="row justify-content-center mb-3">
      {{-- <div class="col-12"> --}}
        <img src="{{ asset('me/educklogo.svg') }}" width="200px" alt="">
      {{-- </div> --}}
    </div>
    <div class="row">
      <div class="col-md-4">
        <div class="footer-col first">
          ...
          <p class="p-small">Somos un equipo de profesi</p>
        </div>
      </div> <!-- end of col -->
      <div class="col-md-4">
        ...
        <div class="footer-col last">
          ...
          <ul class="list-unstyled li-space-lg p-small">
            <li class="media">
              ...
              <div class="media-body">Santiago, Chile.</div>
            </li>
            <li class="media">
              <i class="fas fa-envelope"></i>
              <div class="media-body">
                <a class="white" href="mailto:informaciones@educk.cl">informaciones@educk.cl</a>
