      ...
      <div class="col-lg-7">
        <div class="text-container">
          ...
          <ul class="list-unstyled li-space-lg">
            ...
            <li class="media">
              <i class="fas fa-square"></i>
              <div class="media-body">La Analítica Descriptiva de <img src="{{ asset('me/logo.svg') }}" width="60px" alt=""> te proporciona el conocimiento necesario para tomar decisiones informadas y estratégicas. Ya no te conformes con suposiciones, <strong>¡haz elecciones basadas en datos concretos!</strong></div>
            </li>
            <li class="media">
              <i class="fas fa-square"></i>
