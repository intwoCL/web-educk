      ...
      <div class="col-lg-12">
        {{-- <div class="alert alert-dark rounded-pill" role="alert" style="background: #000; color: #fff;">
          <strong class="text-justify">
            Soluciones de nuestro Software
          </strong>
        </div> --}}
    ...
    <div class="row">
      <div class="col-lg-6">
        <div class="text-container">
          <img src="{{ asset('me/logo-ganapuntos.png') }}" width="100px" alt="">
          <h3>Sistema de gestión GANAPUNTOS</h3>
          <p>Es un sistema que te permite gestionar recompensas acumulando puntos
            para luego ser canjeados en la misma página.
          </p>
          <ul class="list-unstyled li-space-lg">
            <li class="media">
              <i class="fas fa-square"></i>
              <div class="media-body"><strong>Moneda - Puntos</strong>: Crea tus propia moneda o puntos y gestionalas como tu quieras.</div>
            </li>
            <li class="media">
              <i class="fas fa-square"></i>
              <div class="media-body"><strong>Recompensas</strong>: Gestiona objetivos para recompensar a tus usuarios.</div>
            </li>
            <li class="media">
              <i class="fas fa-square"></i>
              <div class="media-body"><strong>Productos - Canjees</strong>: Intercambia puntos por una amplia variedad de productos y/o articulos.</div>
            </li>
          </ul>
      ...
      <div class="col-lg-6">
        <div class="image-container">
          <img class="img-fluid rounded shadow" src="{{ asset('me/ganapuntos.png') }}" alt="sistema ganapuntos">
        </div>
      </div>
    </div>
  </div>
