  ...
  <div class="container">
    ...
    <div class="row mt-3">
      ...
      <div class="col-lg-4">
        <div class="card">
          <div class="card-image">
            <img class="img-fluid" src="{{ asset('me/banner/undraw_timeline_re_aw6g.svg') }}" alt="alternative">
          </div>
          <div class="card-body">
      ...
      <div class="col-lg-4">
        <div class="card">
          <div class="card-image">
            <img class="img-fluid" src="{{ asset('me/banner/undraw_absorbed_in_re_ymd6.svg') }}" alt="alternative">
          </div>
          <div class="card-body">
      ...
      <div class="col-lg-4">
        <div class="card">
          <div class="card-image">
            <img class="img-fluid" src="{{ asset('me/banner/undraw_pie_chart_re_bgs8.svg') }}" alt="alternative">
          </div>
          <div class="card-body">
      ...
      <div class="col-lg-4">
        <div class="card">
          <div class="card-image">
            <img class="img-fluid" src="{{ asset('me/banner/undraw_documents_re_isxv.svg') }}" alt="alternative">
          </div>
          <div class="card-body">
      ...
      <div class="col-lg-4">
        <div class="card">
          <div class="card-image">
            <img class="img-fluid" src="{{ asset('me/banner/undraw_happy_announcement_re_tsm0.svg') }}" alt="alternative">
          </div>
          <div class="card-body">
